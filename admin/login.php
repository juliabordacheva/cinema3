...
<main>
    <section class="login">
        ...
        <div class="login__wrapper">
            <form class="login__form" action="auth.php" method="POST" accept-charset="utf-8">
                <label class="login__label" for="mail">
                    E-mail
                    <input class="login__input" type="mail" placeholder="example@domain.xyz" name="email" required>
                </label>
